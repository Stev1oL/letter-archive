<nav class="topnav navbar navbar-expand shadow justify-content-between justify-content-sm-start navbar-light bg-white" id="sidenavAccordion">
    ...
    <img class="img-fluid" src="/admin/assets/img/logo.png" style="max-width: 3rem;margin-left: 5px;" />
    @if(Auth::user()->role === 'super_admin')
    <a class="navbar-brand pe-3 ps-4 ps-lg-2" href="{{ route('superadmin-dashboard') }}">
        E-ARSIP SURAT
    </a>
    ...
    <a class="navbar-brand pe-3 ps-4 ps-lg-2" href="{{ route('user-dashboard') }}">
        E-ARSIP SURAT
    </a>
    @endif
    <!-- Navbar Search Input-->
