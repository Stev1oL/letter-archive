...
<main>
            ...
            <div class="page-header-content">
                <div class="row align-items-center justify-content-between pt-3">
                    ...
                    <div class="col-12 col-xl-auto mb-3">
                        <a class="btn btn-sm btn-light text-primary" href="{{ route('surat-disposisi-user') }}">
    ...
    <div class="container-fluid px-4">
        ...
        @endif
        <form action="{{ route('disposisi-user.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row gx-4">
                <div class="col-lg-9">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <textarea id="catatan_rektors" class="form-control @error('catatan_rektor') is-invalid @enderror" name="catatan_rektor" placeholder="Catatan Pimpinan.." required>{{ old('catatan_rektor') }}</textarea>
                                </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <select name="kepada" class="form-control" required>
                                        ...
                                        <option value="{{ $department->name }}" {{ (old('department_id') == $department->id)? 'selected':''; }}>{{ $department->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                @error('kepada')
