            ...
            <div class="col-lg-12">
                <div class="card card-header-actions mb-4">
                    <div class="card-header">
                        Data :
                        <div>
                            <a class="btn btn-sm btn-warning" href="{{ route('disposisi-user.create') }}">
                                <i data-feather="plus-square"></i> &nbsp;
                                Tambah Surat
                            </a>
                            <a class="btn btn-sm btn-success" href="{{ route('print-surat-disposisi-user') }}" target="_blank">
    ...
    $('#crudTable').ready(function() {
        $.ajax({
            ...
            success: function(data) {
                ...
                var filteredData = data.filter(function(kepada) {
                    return kepada === user;
                });
