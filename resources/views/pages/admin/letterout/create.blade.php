...
<main>
    ...
    <div class="container-fluid px-4">
        ...
        @endif
        <form action="{{ route('letterout.store') }}" method="post" enctype="multipart/form-data" novalidate>
            @csrf
            <div class="row gx-4">
                <div class="col-lg-9">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control @error('copy') is-invalid @enderror" value="{{ old('copy') }}" name="copy" placeholder="Lampiran..." required>
                                </div>
                                @error('copy')
                                <div class="invalid-feedback">
                                    {{ $message; }}
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <textarea id="content" class="form-control @error('content') is-invalid @enderror" value="{{ old('content') }}" name="content" placeholder="Isi..." required></textarea>
                                </div>
                                @error('content')
                                <div class="invalid-feedback">
                                    {{ $message; }}
