...
<body>
    <table align="center" cellpadding="1" style="width: 700px; border: none;" class="table-bordered">
        <tbody style="border: none;">
            <tr>
                <td valign="top">
                    <div align="center">
                        <span style="font-size: x-small;"><img src="/admin/assets/img/logo.png" style="max-width: 7rem;" alt=""></span>
                    </div>
                </td>
                <td colspan="2">
                    <table style="border: none;" cellpadding="1" style="width: 500px;text-align: center;">
                        <tbody>
                            <tr>
            ...
            <tr>
                <td colspan="2">
                    <table style="border: none;" cellpadding="1" style="border: none;" style="width: 400px;">
                        <tbody>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td width="8"><span style="font-size: x-small;">:</span></td>
                                <td width="200"><span style="font-size: x-small;"> {{ $item->letter->department->institution }} </span></td>
                            </tr>
                        </tbody>
                    </table>
                </td>
            ...
            <tr>
                <td colspan="3">
                    <table border="0" style="border: none;" cellpadding="1" style="width: 400px;">
                        <tbody>
                            <tr valign="top">
            ...
            <tr>
                <td colspan="2" valign="top">
                    <table border="0" style="border: none;" cellpadding="1" style="width: 400px;">
                        <tbody>
                            <tr valign="top">
                                <td width="400"><span style="font-size: x-small;">&emsp;<U>Disposisi Pimpinan kepada :</U> </span></td>
                            </tr>
                        </tbody>
                    </table>
                    <table border="0" style="border: none;" cellpadding="1" style="width: 400px;">
                ...
                <td colspan="1" valign="top">
                    <table border="0" style="border: none;" cellpadding="1" style="width: 200px;">
                        <tbody>
                            <tr valign="top">
                    ...
                    <table border="0" style="border: none;" cellpadding="1" style="width: 280px;">
                        <tfoot>
                            <tr>
                                <div class="row" style="float: left;">
                                    <div class="col">
            ...
            <tr>
                <td colspan="3" style="height: 80px;" valign="top">
                    <table border="0" style="border: none;" cellpadding="1" style="width: 400px;">
                        <tbody>
                            <tr valign="top">
                                <td width="93"><span style="font-size: x-small;"> <u> CATATAN PIMPINAN</u> </span></td>
                                <td width="8"><span style="font-size: x-small;">:</span></td>
