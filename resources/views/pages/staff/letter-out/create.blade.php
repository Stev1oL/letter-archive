...
<main>
            ...
            <div class="page-header-content">
                <div class="row align-items-center justify-content-between pt-3">
                    ...
                    <div class="col-12 col-xl-auto mb-3">
                        <a class="btn btn-sm btn-light text-primary" href="{{ route('surat-keluar-staff') }}">
    ...
    <div class="container-fluid px-4">
        ...
        @endif
        <form action="{{ route('letter-out.store') }}" method="post" enctype="multipart/form-data" novalidate>
            @csrf
            <div class="row gx-4">
                <div class="col-lg-9">
                    <div class="card mb-4">
