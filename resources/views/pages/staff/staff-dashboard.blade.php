                ...
                <div class="card h-100">
                    <div class="card-body h-100 p-5">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-4 col-xxl-12 text-center"><img class="img-fluid" src="/admin/assets/img/illustrations/img-app-surat.png" style="max-width: 15rem" alt="" /></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-xl-6 mb-4">
                <div class="card bg-primary text-white h-100">
                    ...
                    <div class="card-footer d-flex align-items-center justify-content-between small">
                        <a class="text-white stretched-link" href="{{ route('surat-masuk-staff') }}">Selengkapnya</a>
            ...
            <div class="col-lg-12 col-xl-6 mb-4">
                <div class="card bg-warning text-white h-100">
                    ...
                    <div class="card-footer d-flex align-items-center justify-content-between small">
                        <a class="text-white stretched-link" href="{{ route('surat-keluar-staff') }}">Selengkapnya</a>
                        <div class="text-white"><i class="fas fa-angle-right"></i></div>
                    </div>
                </div>
            </div>
