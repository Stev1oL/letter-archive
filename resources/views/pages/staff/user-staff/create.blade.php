            ...
            <div class="page-header-content">
                <div class="row align-items-center justify-content-between pt-3">
                    ...
                    <div class="col-12 col-xl-auto mb-3">
                        <a class="btn btn-sm btn-light text-primary" href="{{ route('user-staff.index') }}">
                        ...
                        <form action="{{ route('user-staff.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <div class="col-md-6">
                                    ...
                                    <!-- <input class="form-control @error('role') is-invalid @enderror" name="role" type="role" value="{{ old('role') }}" required /> -->
                                    @error('role')
                                    <div class="invalid-feedback">
                                        {{ $message; }}
                                    </div>
