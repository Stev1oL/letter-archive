...
<main>
    ...
    <div class="container-xl px-4 mt-4">
        ...
        <nav class="nav nav-borders">
            <a class="nav-link {{ (request()->is('staff/setting-staff')) ? 'active ms-0' : '' }}" href="{{ route('setting-staff.index') }}">Profil</a>
            <a class="nav-link {{ (request()->is('staff/setting-staff/change-password')) ? 'active ms-0' : '' }}" href="{{ route('change-password-staff') }}">Ubah Password</a>
        </nav>
        <hr class="mt-0 mb-4" />
        <div class="row">
            <div class="col">
            ...
            <div class="col-xl-4">
                ...
                <div class="card mb-4 mb-xl-0">
                    ...
                    <div class="card-body text-center">
                        ...
                        <form action="{{ route('profile-upload-staff') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="id" value="{{ $user->id }}">
                            <input type="file" id="profile" name="profile" style="display: none;" onchange="form.submit()" />
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('user-staff.update', $user->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" name="role" type=role" value="{{ $user->role }}" readonly />
                            </div>
                            <!-- Save changes button-->
