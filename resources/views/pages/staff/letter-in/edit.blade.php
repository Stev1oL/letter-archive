                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="date" class="form-control @error('date_received') is-invalid @enderror" value="{{ Date($item->date_received) }}" name="date_received" required>
                                </div>
                                @error('date_received')
                                <div class="invalid-feedback">
                                    {{ $message; }}
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="file" class="form-control @error('letter_file') is-invalid @enderror" value="{{ old('letter_file') }}" name="letter_file" accept="application/pdf">
